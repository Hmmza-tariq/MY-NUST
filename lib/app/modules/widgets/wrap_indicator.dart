...
class WarpIndicator extends StatefulWidget {
  ...
  static Color _defaultStarColorGetter(int index) {
    ...
    bool isLightTheme = themeController.theme.brightness == Brightness.light;

    if (isLightTheme) {
      // Darker colors for light theme
      return HSLColor.fromAHSL(1, Random().nextDouble() * 360, 1, 0.2)
          .toColor();
    } else {
      // Lighter colors for dark theme
      return HSLColor.fromAHSL(1, Random().nextDouble() * 360, 1, 0.98)
          .toColor();
    }
  }
